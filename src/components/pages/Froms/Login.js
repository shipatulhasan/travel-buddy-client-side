...
const Login = () => {
    ...
    const {user, googleSignUp, userSignIn} = useContext(AuthContext)
    ...
    return (
        <div className="h-full w-full py-16 px-4 bg-center bg-no-repeat bg-cover bg-black bg-opacity-10 bg-blend-overlay" style={{backgroundImage:`url(${bg})`}}>
            <div className="flex flex-col items-center justify-center">
               <Link to='/'><img src={logo} alt="" /></Link>
                <div className="bg-white bg-opacity-60 shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <button onClick={handleSignInWithGoogle} aria-label="Continue with google"  className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10 hover:bg-fuchsia-900 hover:text-slate-100 text-base font-medium">
                        ...
                        <p className="text-base font-medium ml-4 text-gray-700 hover:text-slate-100"></p>
                        Continue with Google
                    </button>
                    <button aria-label="Continue with github"  className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4 hover:bg-fuchsia-900 hover:text-slate-100 text-base font-medium">
                    ...
                    <div className="mt-6  w-full">
                        ...
                        <div className="relative flex items-center justify-center">
                            <input type={viewPass?'text':'password'} name='password' className="bg-gray-200 border rounded focus:outline-none text-base font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                    ...
                    <div className="mt-6">
                        <button aria-label="create my account" className="focus:ring-2 focus:ring-offset-2 focus:ring-slate-100 text-base font-semibold leading-none text-white focus:outline-none bg-fuchsia-900 border rounded hover:bg-fuchsia-800 py-4 w-full">
                            Login
                        </button>
                    </div>
                    </form>
                    
                        <Link to='/reset-password' tabIndex={0} role="link" className=" text-base font-medium leading-none underline text-fuchsia-900 cursor-pointer">
                            <p className='mt-4'>
                            Forget Password
                            </p>
