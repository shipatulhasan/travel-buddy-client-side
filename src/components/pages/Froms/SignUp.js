...
import bg from '../../../asset/images/signup1.jpg'
...
const Signup = () => {
    ...
    const {googleSignUp, userRegistration, updateUserProfile} = useContext(AuthContext)
    ...
    const handleSubmit = (e)=>{
        ...
        // console.log(email,email,pass,name,photoUrl)
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="bg-white bg-opacity-60 shadow rounded  md:w-1/2 w-full p-10 mt-16">
                <p tabIndex={0}  aria-label="Login to your account" className="text-2xl font-extrabold leading-6 text-gray-800">
                    Sign up and book your next tour
                </p>
                <p className="text-base mt-4 font-medium leading-none text-gray-800">
                    Already have account?{" "}
                    <Link to ='/login' tabIndex={0} role="link" aria-label="Sign up here" className="text-base font-medium leading-none underline text-fuchsia-900 cursor-pointer">
                        {" "}
                        Sign in here
                    </Link>
                </p>
                <div className='w-full md:flex items-center  gap-5 my-10'>
                <button aria-label="Sign Up with google"
                  
                  onClick={handleSignUpWithGoogle}
                  
                  className="w-5/12 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center  mt-4">
                ...
                <button aria-label="Sign Up with github"  className=" w-5/12 focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center  mt-4">
                    ...
                    <p className="text-base font-medium ml-4 text-gray-700">Sign Up with Github</p>
                </button>
                </div>
                ...
                <div className="mt-8">
                    <button aria-label="create my account" className="focus:ring-2 focus:ring-offset-2 focus:ring-slate-100 text-base font-semibold leading-none text-white focus:outline-none bg-fuchsia-800 border rounded hover:bg-fuchsia-700 py-4 w-full" type='submit'>
                        Create new account
                    </button>
                </div>
                </form>
